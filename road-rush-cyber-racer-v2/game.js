...
let currentQuestion=null,hintUsed=false,quizTimer=null,quizTimeLeft=0; const pauseBtn=document.getElementById('pauseBtn'); pauseBtn.onclick = () => {
...
}; const HINT_UNLOCK_SCORE=1200; const QUIZ_LIMITS={1:20,2:30,3:60};
